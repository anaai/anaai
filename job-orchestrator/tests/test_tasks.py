...
class TasksTestCase(TestCase):
  ...
  def test_cartoonification(self, download_mock, pinata_mock, dir_mock, cv2_mock, requests_mock):
    image_url = "image_url"
  ...
  @patch("tasks.PinataClient")
  @patch("tasks._download_image")
  def test_ascii(self, download_mock, pinata_mock, dir_mock, cv2_mock, requests_mock):
    image_url = "image_url"
    image_name = "image_name"
    image_path = "image_path"
    image_ipfs_url = "pinata_hash_123"
